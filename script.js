...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const addItemOrderButton = document.getElementById('add_item_order'); // Button to add item order
  ...
  // Function to import items and workers from the server
  ...
  // Function to handle adding an order to the system
  ...
  // Function to fetch and display staff information
  ...
  // Function to show assigned orders for a specific worker
  ...
  // Function to fire a worker from the system
  ...
  // Function to validate the worker form before submission
  ...
  // Function to clear the worker form fields after submission
  ...
  // Function to fetch payment order data from the server
  ...
  // Function to add event listeners to payment order buttons for actions
  ...
  // Function to fetch payment types for the dropdown selection
  ...
  // Function to fetch order items for liability dropdown selection
  ...
  // Function to fetch transactions for a specific finance ID
  ...
  // Function to fetch liabilities for a specific finance ID
  ...
  // Function to validate transaction form before submission
  ...
  // Function to validate liability form before submission
  ...
  // Add event listeners for the payment forms to handle submissions
  ...
  // Load payment orders when the payment order page is shown
