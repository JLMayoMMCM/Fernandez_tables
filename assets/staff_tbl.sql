...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2025 at 02:40 PM
...
(20000011, 'eq', 'qwr', 'q'),
(20000012, 'eq', 'qwr', 'q'),
(20000013, '123', '435', '567'),
(20000014, '123', '435', '567');
...
INSERT INTO `event_info_tbl` (`event_ID`, `event_Name`, `address_ID`, `event_date`) VALUES
(70000001, 'wedding', 20000006, '2025-03-01 13:24:00'),
(70000002, 'wedding', 20000007, '2025-03-01 13:24:00'),
(70000003, 'wedding', 20000008, '2025-03-01 13:24:00'),
(70000004, '213qw', 20000011, '2025-03-13 03:30:00'),
(70000005, '213qw', 20000012, '2025-03-13 03:30:00'),
(70000006, '123', 20000013, '2025-03-10 16:30:00'),
(70000007, '123', 20000014, '2025-03-10 16:30:00');
...
INSERT INTO `finance_tbl` (`finance_ID`, `order_ID`, `payment_status_id`) VALUES
(3, 10000002, 301),
(4, 10000003, 301);
...
(10000002, 80000006, 4),
(10000002, 80000007, 16),
(10000003, 80000006, 4),
(10000003, 80000007, 16);
...
(10000002, 60000009, '2025-03-02 13:36:02', 30000002),
(10000003, 60000010, '2025-03-02 13:36:10', 30000002);
...
(10000010, '123', '789', '456', '12345678', 0, 901),
(10000011, 'Ja', 'Se', 'Ma', '09201243', 0, 901),
(10000012, 'Ja', 'Se', 'Ma', '09201243', 0, 901),
(10000013, 'Ja', 'Se', 'Ma', '09201243', 0, 901),
(10000014, 'Ja', 'Se', 'Ma', '09201243', 0, 901),
(10000015, 'Ja', 'Se', 'Ma', '09201243', 0, 901),
(10000018, 're', 'wqe', 'wqe', '7896783', 0, 901),
(10000019, 're', 'wqe', 'wqe', '7896783', 0, 901),
(10000020, '1asd', 'qwd', 'wqe', '1209854', 0, 901),
(10000021, '1asd', 'qwd', 'wqe', '1209854', 0, 901);
...
--
ALTER TABLE `address_tbl`
  MODIFY `address_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20000015;

--
-- AUTO_INCREMENT for table `customer_tbl`
--
ALTER TABLE `customer_tbl`
  MODIFY `customer_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60000011;

--
-- AUTO_INCREMENT for table `event_info_tbl`
--
ALTER TABLE `event_info_tbl`
  MODIFY `event_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70000008;

--
-- AUTO_INCREMENT for table `finance_tbl`
--
ALTER TABLE `finance_tbl`
  MODIFY `finance_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `order_info_tbl`
  MODIFY `order_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000004;
...
--
ALTER TABLE `person_tbl`
  MODIFY `person_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000022;
