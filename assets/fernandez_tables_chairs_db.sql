...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2025 at 03:30 PM
...
(1002, '', 10000002, '2025-02-28 08:04:04'),
...
--
ALTER TABLE `item_stock_tbl`
  MODIFY `item_stock_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000001;

--
-- AUTO_INCREMENT for table `item_tbl`
--
ALTER TABLE `item_tbl`
  MODIFY `item_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000001;
...
--
ALTER TABLE `payment_tbl`
  MODIFY `payment_ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000001;
...
ALTER TABLE `finance_tbl`
  ...
  ADD CONSTRAINT `finance_tbl_ibfk_2` FOREIGN KEY (`payment_ID`) REFERENCES `payment_tbl` (`payment_ID`),
...
--
ALTER TABLE `item_tbl`
  ADD CONSTRAINT `item_tbl_ibfk_1` FOREIGN KEY (`item_stock_ID`) REFERENCES `item_stock_tbl` (`item_stock_ID`);
